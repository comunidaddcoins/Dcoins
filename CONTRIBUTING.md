Contributing to Dcoins Core
==================================

The Dcoins Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Dcoins Core project, and is not to be
confused with overall Dcoins Network Protocol consensus changes.

Whether a pull request is merged into Dcoins Core rests with the project merge
...
Patches that change Dcoins consensus rules are considerably more involved than
...
Where a patch set proposes to change the Dcoins consensus, it must have been
...
The project leader is the release manager for each Dcoins Core release.
