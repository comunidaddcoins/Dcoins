...
Intro
-----
Dcoins (DCO) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Dcoins utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run dcoins-qt.exe.

Dcoins Core is the original Dcoins client and it builds the backbone of the network.
However, it downloads and stores the entire history of Dcoins transactions;
