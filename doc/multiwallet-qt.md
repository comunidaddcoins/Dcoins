...
In order to support loading of multiple wallets in dcoins-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is dcoins.cpp.
...
Changes to dcoins.cpp
----------------------
dcoins.cpp is the entry point into dcoins-qt, and as such, will require some minor modifications to provide hooks for
