...
This mechanism has been integrated into Bitcore-Node-Dcoins which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/dcoins/insight-api-dcoins#web-socket-api](https://github.com/dcoins/insight-api-dcoins#web-socket-api)
* API: [https://github.com/dcoins/insight-api-dcoins#swifttx-transactions](https://github.com/dcoins/insight-api-dcoins#swifttx-transactions)
...
By default, the Dcoins Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Dcoins Core daemon:
