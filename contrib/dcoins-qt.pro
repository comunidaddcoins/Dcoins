...
RESOURCES += src/qt/dcoins.qrc src/qt/dcoins_locale.qrc

TRANSLATIONS += src/qt/locale/dcoins_bg.ts \
                src/qt/locale/dcoins_de.ts \
                src/qt/locale/dcoins_en.ts \
                src/qt/locale/dcoins_es.ts \
                src/qt/locale/dcoins_fi.ts \
                src/qt/locale/dcoins_fr.ts \
                src/qt/locale/dcoins_it.ts \
                src/qt/locale/dcoins_ja.ts \
                src/qt/locale/dcoins_pl.ts \
                src/qt/locale/dcoins_pt.ts \
                src/qt/locale/dcoins_ru.ts \
                src/qt/locale/dcoins_sk.ts \
                src/qt/locale/dcoins_sv.ts \
                src/qt/locale/dcoins_vi.ts \
                src/qt/locale/dcoins_zh_CN.ts \
                src/qt/locale/dcoins_zh_TW.ts
