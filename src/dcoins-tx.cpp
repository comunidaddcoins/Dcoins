...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Dcoins Core dcoins-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  dcoins-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded dcoins transaction") + "\n" +
                               "  dcoins-tx [options] -create [commands]   " + _("Create hex-encoded dcoins transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded dcoins transaction
