...
int nStakeTargetSpacing = 60; // Dcoins: 1 minute blocks during POS (block 201+)
...
{
    // Dcoins will hash in the transaction hash and the index number in order to make sure each hash is unique
