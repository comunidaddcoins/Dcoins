                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Dcoins Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a DCO address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and dcoins: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Dcoins Core"), this);
    aboutAction->setStatusTip(tr("Show information about Dcoins Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Dcoins"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your DCO addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified DCO addresses"));
    ...
    openAction->setStatusTip(tr("Open a dcoins: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Dcoins Core help message to get a list with possible Dcoins command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Dcoins Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Dcoins network", "", count));
}
...
{
    QString strTitle = tr("Dcoins Core"); // default title
