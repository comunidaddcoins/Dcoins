...
/** Utility functions used by the Dcoins Qt UI.
 */
namespace GUIUtil
{
...
// Render DCO addresses in monospace font
...
// Parse "dcoins:" URI into recipient object, return true on successful parsing
